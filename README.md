...
## <a name="charapter-5">Глава 5. WebSockets</a>
...
В этом примере мы остановимcя на обычном _console.log()_ и оставим читателю возможность самим осуществить более продвинутые методы обработки ошибок:
