...
## <a name="part1">Часть 1.</a> Введение в Redux

## <a name="charapter1">Глава 1.</a> Основные понятия Flux и Redux
...
## <a name="charapter2">Глава 2.</a> Ваше первое Redux приложение
