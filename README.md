...
Мы начнем с создания магазина. В Redux существует только одно хранилище (store), которое создается и инициализируется методом _createStore()_. Давайте откроем наш файл _index.js_ и создадим его:
